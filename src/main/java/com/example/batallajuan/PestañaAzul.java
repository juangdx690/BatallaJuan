...
public class PestañaAzul extends Stage {
    ...
    public PestañaAzul() {
        ...
        Timeline moverse = new Timeline(new KeyFrame(Duration.seconds(1), e -> {
            ...
            for (Barco barco : this.control.getBarcos()) {
                ...
                if (barco.getNombre().equals("destructor") && barco.getEquipo().equals("Francia")) {
                    if (barco.getVida()<=0){
                ...
                if (barco.getNombre().equals("acorazado") && barco.getEquipo().equals("Francia")) {
                    if (barco.getVida()<=0){
                ...
                if (barco.getNombre().equals("lancha") && barco.getEquipo().equals("Francia")) {
                    if (barco.getVida()<=0){
                ...
                if (barco.getNombre().equals("submarino") && barco.getEquipo().equals("Francia")) {
                    if (barco.getVida()<=0){
    ...
    private void cargarInterfaz() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("equipoAzul.fxml"));
