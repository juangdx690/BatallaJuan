...
*/
    ...
    public void instanciarBarcos() {
        ...
        control.addBarco(barcoDesEsp = new Barco("destructor", "España", destructorImg, control.getBarcos(), bola));
        ...
        control.addBarco(barcoAcoEsp = new Barco("acorazado", "España", acorazadoImg, control.getBarcos(), bola));
        ...
        control.addBarco(barcoLanEsp = new Barco("lancha", "España", lanchaImg, control.getBarcos(), bola));
        ...
        control.addBarco(barcoSubEsp = new Barco("submarino", "España", submarinoImg, control.getBarcos(), bola));
        ...
        control.addBarco(barcoDesFr = new Barco("destructor", "Francia", destructorImg2, control.getBarcos(), bola));
        ...
        control.addBarco(barcoAcoFr = new Barco("acorazado", "Francia", acorazadoImg2, control.getBarcos(), bola));
        ...
        control.addBarco(barcoLanFr = new Barco("lancha", "Francia", lanchaImg2, control.getBarcos(), bola));
        ...
        control.addBarco(barcoSubFr = new Barco("submarino", "Francia", submarinoImg2, control.getBarcos(), bola));
